...
var binaryOperators = { // These are functions in the vector class, in vector.js
    ...
    '<': 'less',
    '<=': 'lessorequal',
//    '===': 'equal',    // unable to make this work in RapydScript environment
//    '!==': 'notequal', // unable to make this work in RapydScript environment
//    '+=': 'plusequal', // GScompiler now converts LEFT += RIGHT to LEFT = LEFT + RIGHT
//    '-=': 'minusequal',
//    '*=': 'timesequal',
//    '/=': 'divideequal'
};
