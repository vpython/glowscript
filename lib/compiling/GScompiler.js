...
5) At the end of the file "runtime.js", delete these lines:
	...
	a = 1;
6) Copy the file to lib/rapydscript/runtime.js.
7) Execute "bin/web-repl-export embedded". This builds the "embedded" (in-browser) compiler.
8) Copy the file embedded/rapydscript.js to lib/rapydscript and change the name to compiler.js.
