...
*/
    ...
    // In GlowScript 2.6, graph and vp_graph were distinct, so for backward compatibility we insert graph = vp_graph and internally make vp_graph equivalent to graph
    var vp_primitives = ["box", "sphere", "simple_sphere", "cylinder", "pyramid", "cone", "helix", "ellipsoid", "ring", "arrow", "compound", "graph"]
