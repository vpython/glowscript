...
get the very latest version from the rapydscript-ng repository. Otherwise, replace the instructions
with the following. I was unable to do this on Windows and did this on a Mac.
...
3) Execute "sudo bin/rapydscript self --complete --test". This will build a compiler in the "dev" folder.
4) Copy the file dev/baselib-plain-pretty.js to lib/rapydscript and change the name to runtime.js.
5) Execute "sudo bin/web-repl-export". The builds the "embedded" (in-browser) compiler.
6) Copy the file embedded_compiler/rapydscript.js to lib/rapydscript and change the name to compiler.js.
