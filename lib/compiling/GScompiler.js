...
with instructions for how to use it. Store the file in lib/rapydscript/compiler.js. Replace all ρσ in file with RS.
...
Though we are no longer using Streamline, we will for now continue to change XY to RS.
