...
5) Insert these statements at the start of runtime.js (this is a kludge; don't know how to invoke the new compiler):
	...
	var RS_len;
6) Execute "sudo bin/web-repl-export embedded". This builds the "embedded" (in-browser) compiler.
7) Copy the file embedded/rapydscript.js to lib/rapydscript and change the name to compiler.js.
...
*/
    ...
    var vp_primitives = ["box", "sphere", "cylinder", "pyramid", "cone", "helix", "ellipsoid", "ring", "arrow", "graph", "compound"]
