...
// Small modification by Bruce Sherwood, 2012 August 14, for GlowScript (glowscript.org).
// Search for GlowScript, where we skip the header line ("GlowScript X.Y CoffeeScript").
...
// Generated by CoffeeScript 1.2.1-pre
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.tokenize = function(code, opts) {
      ...
      // GlowScript modification to ignore header line ("GlowsScript X.Y CoffeeScript")
      i = code.search('\n')
      if (i === null) i = code.length
      else i += 1
    ...
    Lexer.prototype.regexToken = function() {
      ...
      if (regex.slice(0, 2) === '/*') {
        this.error('Cannot use /* ... */ comments in CoffeeScript, nor can a regular expression begin with `*`');
      }
      if (regex === '//') regex = '/(?:)/';
    ...
    while (true) {
        ...
        if (typeof action === "undefined" || !action.length || !action[0]) {
            if (!recovering) {
                ...
                if (errStr != "") this.parseError(errStr, {text: this.lexer.match, token: this.terminals_[symbol] || symbol, line: this.lexer.yylineno, loc: yyloc, expected: expected});
            }
        }
