...
function exportAce(ns) {
    ...
    if (typeof requirejs !== "undefined") {
        ...
        global.define = function(id, deps, callback) {
            ...
            return define(id, deps, function(ace_require, exports, module) {
                if (deps[2] == "module")
    ...
    if (root.ace_require)
        _require.original = root.ace_require;
...
// The following ace_require()s are for inclusion in the built ace file
ace_require("./worker/worker_client");
ace_require("./keyboard/hash_handler");
ace_require("./keyboard/state_handler");
...
exports.edit = function(el) {
    ...
    var editor = new Editor(new Renderer(el, ace_require("./theme/textmate")));
...
exports.addCommandKeyListener = function(el, callback) {
    ...
    if (useragent.isOldGecko || (useragent.isOpera && !("KeyboardEvent" in window))) {
        ...
        addListener(el, "keydown", function(e) {
            //lastDown = e.keyIdentifier || e.keyCode; // deprecated Sept. 2016
            lastDown = e.key || e.keyCode;
...
define('ace/editor', ['ace_require', 'exports', 'module' , 'ace/lib/fixoldbrowsers', 'ace/lib/oop', 'ace/lib/lang', 'ace/lib/useragent', 'ace/keyboard/textinput', 'ace/mouse/mouse_handler', 'ace/mouse/fold_handler', 'ace/keyboard/keybinding', 'ace/edit_session', 'ace/search', 'ace/range', 'ace/lib/event_emitter', 'ace/commands/command_manager', 'ace/commands/default_commands'], function(ace_require, exports, module) {
...
//var TouchHandler = ace_require("./touch_handler").TouchHandler;
...
define('ace/keyboard/textinput', ['ace_require', 'exports', 'module' , 'ace/lib/event', 'ace/lib/useragent', 'ace/lib/dom'], function(ace_require, exports, module) {
...
define('ace/mouse/mouse_handler', ['ace_require', 'exports', 'module' , 'ace/lib/event', 'ace/mouse/default_handlers', 'ace/mouse/default_gutter_handler', 'ace/mouse/mouse_event', 'ace/mouse/dragdrop'], function(ace_require, exports, module) {
...
define('ace/mouse/default_gutter_handler', ['ace_require', 'exports', 'module' , 'ace/lib/dom'], function(ace_require, exports, module) {
...
define('ace/edit_session', ['ace_require', 'exports', 'module' , 'ace/config', 'ace/lib/oop', 'ace/lib/lang', 'ace/lib/net', 'ace/lib/event_emitter', 'ace/selection', 'ace/mode/text', 'ace/range', 'ace/document', 'ace/background_tokenizer', 'ace/search_highlight', 'ace/edit_session/folding', 'ace/edit_session/bracket_match'], function(ace_require, exports, module) {
...
(function() {
    ...
    **/
    ...
    this._loadMode = function(mode, callback) {
        ...
        var module;
        try {
            module = ace_require(mode);
        } catch (e) {};
        // sometimes ace_require returns empty object (this bug is present in requirejs 2 as well)
...
define('ace/config', ['ace_require', 'exports', 'module' , 'ace/lib/lang'], function(ace_require, exports, module) {
"no use strict";
...
define('ace/lib/net', ['ace_require', 'exports', 'module' ], function(ace_require, exports, module) {
...
define('ace/mode/text', ['ace_require', 'exports', 'module' , 'ace/tokenizer', 'ace/mode/text_highlight_rules', 'ace/mode/behaviour', 'ace/unicode'], function(ace_require, exports, module) {
...
define('ace/edit_session/fold', ['ace_require', 'exports', 'module' ], function(ace_require, exports, module) {
...
define('ace/keyboard/hash_handler', ['ace_require', 'exports', 'module' , 'ace/lib/keys'], function(ace_require, exports, module) {
...
define('ace/commands/default_commands', ['ace_require', 'exports', 'module' , 'ace/lib/lang'], function(ace_require, exports, module) {
...
define('ace/virtual_renderer', ['ace_require', 'exports', 'module' , 'ace/lib/oop', 'ace/lib/dom', 'ace/lib/event', 'ace/lib/useragent', 'ace/config', 'ace/lib/net', 'ace/layer/gutter', 'ace/layer/marker', 'ace/layer/text', 'ace/layer/cursor', 'ace/scrollbar', 'ace/renderloop', 'ace/lib/event_emitter', 'text!ace/css/editor.css'], function(ace_require, exports, module) {
...
var EventEmitter = ace_require("./lib/event_emitter").EventEmitter;
var editorCss = ace_require("text!./css/editor.css");
...
define('ace/layer/gutter', ['ace_require', 'exports', 'module' , 'ace/lib/dom', 'ace/lib/oop', 'ace/lib/event_emitter'], function(ace_require, exports, module) {
...
define('ace/multi_select', ['ace_require', 'exports', 'module' , 'ace/range_list', 'ace/range', 'ace/selection', 'ace/mouse/multi_select_handler', 'ace/lib/event', 'ace/commands/multi_select_commands', 'ace/search', 'ace/edit_session', 'ace/editor'], function(ace_require, exports, module) {
...
define('ace/range_list', ['ace_require', 'exports', 'module' ], function(ace_require, exports, module) {
...
var WorkerClient = function(topLevelNamespaces, mod, classname) {
    ...
    if (config.get("packaged")) {
        ...
        var workerUrl;
        if (typeof ace_require.supports !== "undefined" && ace_require.supports.indexOf("ucjs2-pinf-0") >= 0) {
            // We are running in the sourcemint loader.
            workerUrl = ace_require.nameToUrl("ace/worker/worker_sourcemint");
        } else {
            ...
            workerUrl = this.$normalizePath(ace_require.toUrl("ace/worker/worker", null, "_"));
        }
        ...
        for (var i=0; i<topLevelNamespaces.length; i++) {
            ...
            var path = this.$normalizePath(ace_require.toUrl(ns, null, "_").replace(/.js(\?.*)?$/, ""));
    ...
    var _self = this;
    // this.$worker.onerror = function(e) { // worker-javascript.js doesn't work, so this is commented out
...
define('ace/keyboard/state_handler', ['ace_require', 'exports', 'module' ], function(ace_require, exports, module) {
...
StateHandler.prototype = {
    ...
    $composeBuffer: function(data, hashId, key, e) {
        ...
        if (e) {
            //bufferObj.keyIdentifier = e.keyIdentifier // deprecated Sept. 2016
            bufferObj.key = e.key
        }
    ...
    handleKeyboard: function(data, hashId, key, keyCode, e) {
        ...
        //var keyId = r.keyIdentifier; // deprecated Sept. 2016
        var keyId = r.key;
...
define('ace/theme/textmate', ['ace_require', 'exports', 'module' , 'text!ace/theme/textmate.css', 'ace/lib/dom'], function(ace_require, exports, module) {


exports.isDark = false;
exports.cssClass = "ace-tm";
exports.cssText = ace_require('text!./textmate.css');
...
;
            (function() {
                ...
                ace_require(["ace/ace"], function(a) {
                    a && a.config.init();
                    if (!window.ace)
                        window.ace = {};
