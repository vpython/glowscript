...
var abs = Math.abs, max = Math.max, min = Math.min, bool = RS_bool, type = RS_type;
var float = RS_float, int = RS_int, arraylike = RS_arraylike_creator(), RS_arraylike = arraylike;
var print = RS_print, id = RS_id, get_module = RS_get_module, pow = RS_pow;
...
function RS_list_sort(key, reverse) {
    var mult, keymap, k;
    ...
    this.sort((function() {
        var RS_anonfunc = function (a, b) {
            return mult * RS_list_sort_cmp(keymap.get(a), keymap.get(b));
        };
        Object.defineProperties(RS_anonfunc, {
            __argnames__ : {value: ["a", "b"]}
        });
...
RS_dict.prototype.toString = RS_dict.prototype.inspect = function () {
