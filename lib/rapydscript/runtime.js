...
if (!RS_print.__module__) Object.defineProperties(RS_print, {
    __module__ : {value: "__main__"}
});
...
if (!RS_arraylike_creator.__module__) Object.defineProperties(RS_arraylike_creator, {
    __module__ : {value: "__main__"}
});
...
function options_object(f) {
    return (function() {
        ...
        if (!RS_anonfunc.__module__) Object.defineProperties(RS_anonfunc, {
            __module__ : {value: "__main__"}
        });
        return RS_anonfunc;
    })();
...
function RS_range(start, stop, step) {
    ...
    ans.__repr__ = (function() {
        var RS_anonfunc = function () {
            return "range(" + RS_str.format("{}", start) + ", " + RS_str.format("{}", stop) + ", " + RS_str.format("{}", step) + ")";
        };
        if (!RS_anonfunc.__module__) Object.defineProperties(RS_anonfunc, {
            __module__ : {value: "__main__"}
        });
...
if (!RS_list_to_string.__module__) Object.defineProperties(RS_list_to_string, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_copy.__module__) Object.defineProperties(RS_list_copy, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_clear.__module__) Object.defineProperties(RS_list_clear, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_as_array.__module__) Object.defineProperties(RS_list_as_array, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_concat.__module__) Object.defineProperties(RS_list_concat, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_slice.__module__) Object.defineProperties(RS_list_slice, {
    __module__ : {value: "__main__"}
});
...
if (!RS_list_len.__module__) Object.defineProperties(RS_list_len, {
    __module__ : {value: "__main__"}
});
...
if (!RS_set_polyfill.__module__) Object.defineProperties(RS_set_polyfill, {
    __module__ : {value: "__main__"}
});
...
if (!RS_dict_polyfill.__module__) Object.defineProperties(RS_dict_polyfill, {
    __module__ : {value: "__main__"}
});
...
var dict = RS_dict, dict_wrap = RS_dict_wrap;// }}}
var NameError;
...
if (!RS_mixin.__module__) Object.defineProperties(RS_mixin, {
    __module__ : {value: "__main__"}
});
...
function RS_instanceof() {
    ...
    for (var i = 1; i < arguments.length; i++) {
        ...
        if (q === RS_int && typeof obj === "number" && Number.isInteger(obj)) {
            return true;
        }
        if (q === RS_float && typeof obj === "number" && !Number.isInteger(obj)) {
            return true;
        }
        if (bases.length > 1) {
...
if (!RS_instanceof.__module__) Object.defineProperties(RS_instanceof, {
    __module__ : {value: "__main__"}
});
...
var decimal_sep, define_str_func, RS_unpack, RS_orig_split, RS_orig_replace;
...
RS_unpack = RS_unpack_asarray(9, RS_unpack);
        ...
        function render_markup(markup) {
            var RS_unpack, key, transformer, format_spec, ends_with_equal, lkey, nvalue, object, ans;
...
RS_unpack = RS_unpack_asarray(3, RS_unpack);
            ...
            if (ends_with_equal) {
                ans = "" + RS_str.format("{}", key) + "=" + RS_str.format("{}", ans) + "";
            }
            return ans;
        };
