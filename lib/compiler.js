        ...
        if (options.lang == "coffeescript") {
        	...
        	if (program.slice(0,7) == 'ERROR: ') {
	        	...
	        	if (options.lang == 'rapydscript' || options.lang == 'vpython') { // enable Python list+list
	        		...
	        		program = program.slice(0,start) + "  Array.prototype['+']=function(r) {return this.concat(r)};\n" + program.slice(start-2)
	        	}
	        	
	        	/*
	        	// "no overloading" no longer works after the Dec. 2015 change in operator overloading
