;(function () {
    ...
    function WebGLRenderer(canvas, canvasElement, overlay) {
    	...
    	*/
        ...
        var textureN = {C0:gl.TEXTURE2, D0:gl.TEXTURE3, D1:gl.TEXTURE4, D2:gl.TEXTURE5, D3:gl.TEXTURE6,
        				   C1:gl.TEXTURE7, C2:gl.TEXTURE8, C3:gl.TEXTURE9, C4:gl.TEXTURE10,
            ...
            */
            ...
            function useProgram(prog, minormode) {
                ...
                if (minormode == MERGE) {
                    ...
                    gl.uniform1i(prog.uniforms.C1,  7) // TEXTURE6  - color map for transparency render 1
                    gl.uniform1i(prog.uniforms.C2,  8) // TEXTURE7  - color map for transparency render 2
                    gl.uniform1i(prog.uniforms.C3,  9) // TEXTURE8  - color map for transparency render 3
	                ...
	                if (minormode > PEEL_D3)
	                	gl.uniform1i(prog.uniforms.D3, 6) // TEXTURE6 - 3rd depth map
                }
            ...
            if (mode == RENDER) {
            	...
            	subrender(PEEL_D3, 'D3', ['D0','D2']) //  8 - 3rd transparency depth; based on D0 and D2
            	
            	subrender(PEEL_C4, 'C4', ['D0','D3']) // 12 - 4th transparency color, based on D0 and D1
