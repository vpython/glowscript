;(function () {
    ...
    function WebGLRenderer(canvas, canvasElement, overlay) {
        ...
        */
        ...
        var object_models = { // models that are the same for VPython/RapydScript/CoffeeScript/JavaScript
        ...
        this.render = function(mode) {
            ...
            */
        	...
        	function add_indices(A, T, obj) {
        		...
        		var nn = canvas.vertex_id-1
        		if (obj.v0.__id > nn || obj.v1.__id > nn || obj.v2.__id > nn) {
        			console.log('out of range', canvas.vertex_id-1, obj.v0.__id, obj.v1.__id, obj.v2.__id)
        			if (Nvert == 4 && obj.v3.__id > nn) console.log('        ', obj.v3.__id)
        		}
	                ...
	                for (var op in sort) { // opaque and transparent
		              ...
		              for (var sort_type in sort[op]) { // plain, textures, bumpmaps, textures_and_bumpmaps
		                for (var sort_list in sort[op][sort_type]) { // lists of index values
		            		...
		            		var nn = canvas.vertex_id-1
		            		for (var ni=1; ni<indices.length; ni++) {
		            			if (indices[ni] > nn) console.log('triangles', nn, indices[ni])
		            		}
