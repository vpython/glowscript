    ...
    function WebGLRenderer(canvas, canvasElement, overlay) {
    	...
    	*/
        ...
        var textureN = {C0:gl.TEXTURE2, D0:gl.TEXTURE3, D1:gl.TEXTURE4, D2:gl.TEXTURE5, 
        				   ...
        				   C4:gl.TEXTURE5, // TEXTURE5 corresponding to D2 is available when creating C4
        ...
        this.render = function(mode) {
            ...
            */
            ...
            if (mode == RENDER) {
            	...
            	subrender(PEEL_C4, 'D2', ['D0','D3']) // 12 - 4th transparency color, based on D0 and D1; write into now available D2
