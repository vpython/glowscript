        ...
        this.render = function(mode) {
            ...
            if (mode == RENDER) {
                ...
                for (var i in canvas.trails) { // attach_trail
                    ...
                    if (!a.__run || obj.__interval > 0) continue // if interval is set, obj.__update_trail adds the points
                	...
                	a.__trail.push({pos:pos, color:a.__color, radius:a.__radius})
            ...
            camera.up = vec3.create([canvas.camera.up.x, canvas.camera.up.y, canvas.camera.up.z])
