...
//--------------------------------------------------------------------------------------------------------
        ...
        this.render = function(mode) {
            ...
            if (mode == RENDER) {
                ...
                if (!canvas.__forward.equals(canvas.__last_forward) || !canvas.__up.equals(canvas.__last_up)) {
                	//console.log('forward or up changed', canvas.billboards.length, canvas.billboards)
