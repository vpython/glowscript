...
//--------------------------------------------------------------------------------------------------------
        ...
        function trigger_render() {
        	setTimeout(trigger_render, 33) // plan on 30 frames per second, adequate for interactivity
            ...
            if (doAverage) {
            	renderMS = renderMS * .95 + (t - lastStartRedraw) * 1000 * .05
            	fps = fps * .95 + (1.0 / (elapsed+.001)) * .05
        	} else {
        		renderMS = (t - lastStartRedraw) * 1000
        		fps = 0
        	}
        ...
        this.reset()
        trigger_render()
        //canvas.trigger_render = trigger_render()
    }
    
    var exports = { WebGLRenderer: WebGLRenderer }
    Export(exports)
})()