            ...
            */
            ...
            function useProgram(prog, minormode) {
                ...
                if (minormode == MERGE) {
                	...
                	gl.uniform1i(prog.uniforms.C4,10) // TEXTURE5  - color map for transparency render 4
	                ...
	                if (minormode > PEEL_D3)
	                	gl.uniform1i(prog.uniforms.D3, 6) // TEXTURE4 - 3rd depth map
                }
            ...
            if (mode == EXTENT) { // The EXTENT machinery doesn't actually work; the intent was to do autoscaling in GPUs
            	...
            	// Debugging:
            	//console.log(id, pixels[0], pixels[1], pixels[2], pixels[3])
            	//var z = 256*pixels[0] + pixels[1]
            	//var w = 256*pixels[2] + pixels[3]
            	//console.log('z, w', z, w, w/z, z*w, z/w)
