                ...
                for(var m in object_models) { 
	                ...
	                for (var id in objs) {
						...
						if (setup) {	                    
				            ...
				            if (minormode == PEEL_D0) {
				            	if (peel_depth_programD0 == null) peel_depth_programD0 = shaderProgram( shaders.peel_depth_fragmentD0, shaders.render_vertex, gl )
				            	useProgram(peel_depth_programD0, minormode)
				            } else if (minormode == PEEL_D1) {
				            	if (peel_depth_programD1 == null) peel_depth_programD1 = shaderProgram( shaders.peel_depth_fragmentD1, shaders.render_vertex, gl )
				            	useProgram(peel_depth_programD1, minormode)
				            } else if (minormode == PEEL_D2) {
				            	if (peel_depth_programD2 == null) peel_depth_programD2 = shaderProgram( shaders.peel_depth_fragmentD2, shaders.render_vertex, gl )
				            	useProgram(peel_depth_programD2, minormode)
				            } else if (minormode == PEEL_D3) {
				            	if (peel_depth_programD3 == null) peel_depth_programD3 = shaderProgram( shaders.peel_depth_fragmentD3, shaders.render_vertex, gl )
