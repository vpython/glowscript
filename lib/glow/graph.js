;(function () {
    ...
    function graph(options) {
    	...
    	this.fastplot = true
    	if (options.fastplot !== undefined) {
    		this.fastplot = options.fastplot
    		delete options.fastplot
    	}
        ...
        if (options.xmin !== undefined) {
            ...
            if (this.fastplot) this.graph_options.xaxis.min = options.xmin
            minmax++
            delete options.xmin
        }
        if (options.xmax !== undefined) {
            this.__xmax = options.xmax
            if (this.fastplot) this.graph_options.xaxis.max = options.xmax
            minmax++
            delete options.xmax
        }
        if (!this.fastplot && minmax == 1) {
	        if (this.__xmin === null && this.__xmax !== null) this.__xmin = 0
	        else throw new Error("You must specify both xmin and xmax.")
        }
        minmax = 0
        if (options.ymin !== undefined) {
            this.__ymin = options.ymin
            if (this.fastplot) this.graph_options.yaxis.min = options.ymin
            minmax++
            delete options.ymin
        }
        if (options.ymax !== undefined) {
            this.__ymax = options.ymax
            if (this.fastplot) this.graph_options.yaxis.max = options.ymax
            minmax++
            delete options.ymax
        }
        if (!this.fastplot && minmax == 1) {
	        if (this.__ymin === null && this.__ymax !== null) this.__ymin = 0
    ...
    property.declare( graph.prototype, {
	        ...
	        set: function (value) {
            	...
            	if (this.__activated) {
            		if (this.fastplot) {
            			...
            			Plotly.relayout(this.__id, {xtitle:value})
            		}
            	}
	        }
    	},
	        ...
	        set: function (value) {
            	...
            	if (this.__activated) {
            		if (this.fastplot) {
            			...
            			Plotly.relayout(this.__id, {ytitle:value})
            		}
            	}
	        }
    	},
	    ...
	    xmin: {
	        ...
	        set: function (value) {
	        	this.__xmin = value
                if (this.fastplot) this.graph_options.xaxis.min = value
	    ...
	    xmax: {
	        ...
	        set: function (value) {
	        	this.__xmax = value
	        	if (this.fastplot) this.graph_options.xaxis.max = value
	    ...
	    ymin: {
	        ...
	        set: function (value) {
	        	this.__ymin = value
	        	if (this.fastplot) this.graph_options.yaxis.min = value
	    ...
	    ymax: {
	        ...
	        set: function (value) {
	        	this.__ymax = value
	        	if (this.fastplot) this.graph_options.yaxis.max = value
	    ...
	    foreground: {
	        ...
	        set: function (value) {
                ...
                if (this.fastplot) this.graph_options.grid.color = col
	    ...
	    background: {
	        ...
	        set: function (value) {
                ...
                var col = color.to_html(value)
                if (this.fastplot) this.graph_options.grid.backgroundColor = col
        ...
        __clear_newdata: function() { // called by completion of Plotly rendering
	    ...
	    __update: function() { // called once by plot function, if graph not yet activated
        	...
        	if (!this.fastplot) { // Plotly
		        ...
		        for (var i=0; i<this.graph_series.length; i++) {
		            ...
		            xs.push(x)
		            ys.push(y)
		            s.__data = s.__data.concat(s.__newdata)
	            ...
	            if (!this.__lock) {
	        		...
	        		Plotly.extendTraces(this.__id, { x:xs, y:ys }, indices).then(function() { self.__clear_newdata() })
	        	}
        	} // end of non-fastplot graph (Plotly)
    	
	    	else { // update fastplot graph (Flot)
	            var info = []
	            for (var i = 0; i < this.graph_series.length; i++) {
	            	var s = this.graph_series[i]
	    	...
	    	} // end of fastplot version of update
    ...
    var to_fastplot_type = { lines: "lines", scatter: "points", 
    ...
    function gobject(options) {
        ...
        if (options.graph !== undefined) {
        	...
        	try {
        		...
        		this.__graph = graph({fastplot:fastplot})
        	}
        }
        ...
        if (this.__graph.fastplot) this.__realtype = to_fastplot_type[this.__type]
        ...
        if (options.width !== undefined) {
            this.__width = options.width
            if (this.__graph.fastplot) this.options[ftype].lineWidth = options.width
            delete options.width
        }
        if (options.markers !== undefined) {
        	...
        	if (options.markers === true) {
	        	...
	        	if (this.__graph.fastplot) this.__linemarker = 
        ...
        if (options.radius !== undefined) {
            ...
            if (this.__graph.fastplot) this.options[ftype].radius = options.radius
            delete options.radius
        }
        if (options.size !== undefined) {
            this.__radius = options.size/2
            if (this.__graph.fastplot) this.options[ftype].radius = options.size/2
            delete options.size
        }
        if (options.horizontal !== undefined) {
            this.__horizontal = options.horizontal
            if (this.__graph.fastplot) this.options[ftype].horizontal = options.horizontal
            delete options.horizontal
        }
        if (options.delta !== undefined) {
            this.__delta = options.delta
            if (this.__graph.fastplot) this.options[ftype].barWidth = options.delta
        ...
        if (options.label !== undefined) {
        	...
        	if (this.__graph.fastplot) this.options.label = options.label
        	if (options.label.length > 0) this.__legend = true
        	delete options.label
        }
        if (options.legend !== undefined) {
        	this.__legend = options.legend
        	if (this.__graph.fastplot && !options.legend && this.__label !== null) delete this.options.label
          ...
          this.plot = function (args) {
        	  ...
        	  if (this.__realtype != 'lines') {
				  for (var i=0; i<data.length; i++) {
		        	  ...
		        	  if (this.__graph.fastplot) this.__data.push(data[i]) // we have to give flot the entire data each time we render
		        	  else this.__newdata.push(data[i]) // with Plotly we can restyle just incrementally (though it's no faster)
				  }
			  } else { // for gcurve, eliminate points that are very close together
				  var pt, x, y, xscale, yscale, dx, dy, x1, x2, y1, y2, lastx, lasty
				  var g = this.__graph
				  var gxmin = g.__xmin
				  var gxmax = g.__xmax
				  var gymin = g.__ymin
				  ...
				  if (this.__data.length === 0) {
					  ...
					  lastx = 1e300 // force using this point
					  lasty = 1e300
				  } else {
					  var xy = this.__data[this.__data.length-1]
					  lastx = xy[0]
					  lasty = xy[1]
				  }
				  for (var i=0; i<data.length; i++) {
					  ...
					  this.__data.push(pt)
		        	  if (this.__graph.fastplot) this.__data.push(pt) // we have to give flot the entire data each time we render
		        	  else this.__newdata.push(pt) // with Plotly we can restyle just incrementally (though it's no faster)
				  }
				  if (this.__graph.fastplot) this.__newdata = [ this.__data[this.__data.length-1] ] // for use by dot
			  }
        	  if (this.__dot) this.__dotobject.data = [ this.__newdata[this.__newdata.length-1] ]
			  this.__graph.__changed = true
			  if (!this.__graph.__activated) this.__graph.__update() // will activate the graph
          }
    ...
    property.declare( gobject.prototype, {
        	...
        	set: function (value) {
                ...
                if (this.__activated) {
                	if (value === true) {
			        	...
			        	if (this.__graph.fastplot) this.options.points = {show: true, radius:r}
			        	else Plotly.restyle(this.__graph.__id, up, this.__id)
		        	} else {
		        		var up = {}
		        		up['marker.size'] = 0.1
			        	if (this.__graph.fastplot) this.options.points = {show: false, radius:r}
			        	else Plotly.restyle(this.__graph.__id, up, this.__id)
			        	this.__graph.__changed = true
		        	}
	        	}
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
                       var col = color.to_html(value)
                        ...
                        //if (this.__realtype == 'lines') this.options.points.fillColor = col
                        //else this.options.fillColor = col
	    ...
	    delta: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
    	                this.options[this.__realtype].barWidth = value
    	                this.__graph.__changed = true
	    ...
	    width: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
    	                this.options[this.__realtype].lineWidth = value
    	                this.__graph.__changed = true
                	} else {
		                var up = {}
                        if (this.__realtype == 'bar') {
	    ...
	    radius: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
    	                this.options[this.__realtype].radius = value
    	                this.__graph.__changed = true
                	} else {
		                var up = {}
                        if (this.__realtype == 'bar') {
	    ...
	    size: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
    	                this.options[this.__realtype].radius = value/2
    	                this.__graph.__changed = true
                	} else {
		                var up = {}
                        if (this.__realtype == 'bar') {
	    ...
	    horizontal: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) {
    	                this.options[this.__realtype].horizontal = value
    	                this.__graph.__changed = true
                	} else {
	    ...
	    orientation: {
	        ...
	        set: function (value) {
                ...
                if (this.__activated) {
                	if (this.__graph.fastplot) this.__graph.__changed = true
		...
		dot_color: {
	        ...
	        set: function (value) {
                ...
                var col = color.to_html(value)
        		if (this.__dotobject.__activated) {
        			if (this.__graph.fastplot) {
                        this.__dotobject.__dot_color = col
                        this.__graph.__changed = true
        			} else {
		                var up = {}
		                up['marker.color'] = col
