;(function () {
    ...
    */
    ...
    function sleep(dt) { // sleep for dt seconds; minimum working sleep is about 5 ms with Chrome, 4 ms with Firefox
        return new Promise( resolve => { setTimeout(() => { resolve() }, 1000*dt) } ) // returns undefined
    }
