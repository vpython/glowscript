;(function () {
   ...
   _shifted[191] = '?'
    ...
    function canvas(options) {
        ...
        this.title_anchor = $("<div/>") // title anchor point
        this.caption_anchor = $("<div/>") // caption anchor point
        this.__titletext = ''
        this.__captiontext = ''
    ...
    property.declare( canvas.prototype, {
        __activate: function () {
            ...
            this.title_anchor.css("white-space","pre").appendTo( container )
            this.menu.css("white-space","pre").appendTo( container )
            this.wrapper.addClass("glowscript-canvas-wrapper").appendTo( container )
            this.caption_anchor.css("white-space","pre").appendTo( container )
