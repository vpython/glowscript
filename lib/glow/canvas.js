   ...
   _shifted[191] = '?'
    ...
    property.declare( canvas.prototype, {
        __activate: function () {
            ...
            $(this.wrapper).data('canvas', this).resizable({
                alsoResize: [this.__canvas_element, this.__overlay_element],
                stop: function(ev, ui) {
                    this.setAttribute('style','width:auto;height:auto;');
                    $(this).data('canvas').width = this.offsetWidth;
                    $(this).data('canvas').height = this.offsetHeight;
                }
            });
        ...
        width: { value: 640, onchanged: function() { 
            this.__canvas_element.width = this.__canvas_element.style.width = this.__overlay_element.width = this.__overlay_element.style.width = this.width;
        } },
        height: { value: 400, onchanged: function() { 
            this.__canvas_element.height = this.__canvas_element.style.height = this.__overlay_element.height = this.__overlay_element.style.height = this.height;
        } },
        align: {
