;(function () {
   ...
   _shifted[191] = '?'
    ...
    window.anchor3 = $("<div/>").css("white-space","pre").appendTo($('body')) // anchor point below caption
	window.anchor3.css({float:"left"})
    ...
    function canvas(options) {
        ...
        this.anchor1 = $("<div/>") // title anchor point
        this.anchor2 = $("<div/>") // caption anchor point
        this.__titletext = ''
        this.__captiontext = ''
    ...
    property.declare( canvas.prototype, {
        __activate: function () {
            ...
            this.anchor1.css("white-space","pre").appendTo( container )
            this.menu.css("white-space","pre").appendTo( container )
            this.wrapper.addClass("glowscript-canvas-wrapper").appendTo( container )
            this.anchor2.css("white-space","pre").appendTo( container )
            //window.__context.anchor3 = $("<div/>").css("white-space","pre").appendTo( container ) // see api_misc.js
            window.anchor3 = $("<div/>").css("white-space","pre").appendTo( container ) // see api_misc.js
            if (this.__titletext.length > 0 || this.__captiontext.length > 0)
            ...
            this.title = this.__titletext
            this.caption = this.__captiontext
        },
        ...
        title: {
            ...
            set: function(value) {
            	this.__titletext = ''
            	this.anchor1.html('')
                this.append_to_title(value) // display the title
            }
        },
        ...
        caption: {
            ...
            set: function(value) {
            	this.__captiontext = ''
                this.anchor2.html('')
                this.append_to_caption(value) // display the caption
            }
        },
