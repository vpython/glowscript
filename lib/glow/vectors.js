;(function () {
    ...
    Number.prototype['+'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? add_error() : this + r }
    Number.prototype['-'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? sub_error() : this - r }
    Number.prototype['*'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? r.multiply(this) : r * this }
    Number.prototype['/'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? divide_error() : this / r }
    Number.prototype['>'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? greater_error() : this > r}
    Number.prototype['<'] =   function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? less_error() : this < r}
    Number.prototype['>='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? greaterorequal_error() : this >= r}
    Number.prototype['<='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? lessorequal_error() : this <= r}
    Number.prototype['+='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? plusequal_error() : this + r}
    Number.prototype['-='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? minusequal_error() : this - r}
    Number.prototype['*='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? timesequal_error() : this * r}
    Number.prototype['/='] =  function(r) {if (r === undefined || Number.isNaN(r)) badnumber(r); return (r instanceof vec) ? divideequal_error() : this / r}
