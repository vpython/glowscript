...
function text3D(a) { // this factory function returns a compound object
    ...
    var comp = compound(meshes, {pos:originalpos, __original_height:textobj.height, __length:maxlength, __billboard: textobj.billboard,
    	__original_descender:textobj.height*descent, visible:textobj.visible, axis:textobj.axis, up:textobj.up, size:textobj.size,
