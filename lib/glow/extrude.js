...
function extrusion(args) { // testing new extrusion machinery
    ...
    function tessellate(contours) {
        ...
        for (i=0; i<tris.length; i++) {
        	...
        	p1 = t.getPoint(1)
        	p2 = t.getPoint(2)
        	vertices.push(vertex({pos:vec(p0.x, p0.y, 0), normal:N}))
        	vertices.push(vertex({pos:vec(p1.x, p1.y, 0), normal:N}))
        	vertices.push(vertex({pos:vec(p2.x, p2.y, 0), normal:N}))
        ...
        for (i=0; i<2; i++) { // must run through this twice if sharp is false
            ...
            for (var k=0; k<V; k++) {
                ...
                if (i === 0) {
                    ...
                    vertices.push(vertex({pos:v, normal:N}))
