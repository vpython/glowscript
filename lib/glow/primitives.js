    ...
    */
    ...
    property.declare( text.prototype, {
    	__update: function() { // will trigger update to this.__comp compound object
    		...
    		var upleft = this.upper_left
			var dz = cross(this.axis,this.up).multiply(this.depth/2)
    		this.__comp.pos = upleft.add(this.axis.norm().multiply(this.length/2)).sub(this.up.norm().multiply(this.size.y/2)).add(dz)
    	},
    	tsize: function() {
