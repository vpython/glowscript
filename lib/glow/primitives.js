; (function () {
    ...
    property.declare( Primitive.prototype, {
        ...
        clone: function(args) { // cloning a standard primitive
        	if (this instanceof text) return this.__comp.clone(args)
	...
	function text(args) { // 3D text object
		...
		return initObject(this, text, {canvas:this.canvas})
	}
    subclass(text, box)
    property.declare( text.prototype, {
        axis:  new attributeVector(null, 1,0,0), // decouple axis and size
        size:  new attributeVector(null, 1,1,1),
        __update: function() {
        	console.log('text update', this.__axis, this.__size)
    	...
    	color: {
    		get: function() { return this.__color },
    		set: function(value) { this.__comp.color = this.__color = value }
    	},
    	size: {
    		get: function() { return this.__size },
    		set: function(value) {
    			this.__comp.__size = this.__size = value
    			this.__comp.__change() // axis and size are decoupled for text object
    		}
    	},
    	axis: {
    		get: function() { return this.__axis },
    		set: function(value) {
    			this.__comp.__axis = this.__axis = value
    			this.__comp.__change() // axis and size are decoupled for text object
    		}
    	},
    	up: {
    		get: function() { return this.__up },
    		set: function(value) { this.__comp.up = this.__up = value }
    	},
    	text: {
