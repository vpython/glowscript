; (function () {
    ...
    /* The handling of the arrow object is complicated. The arrow (or vp_arrow) object itself does not
       ...
       that the box and pyramid objects must be handled. Two other functions that check for components
       are canvas.objects, which returns the arrow object, not its components, and in the render
