; (function () {
    ...
    function initObject(obj, constructor, args) {
        ...
        if (constructor == arrow && args.axis_and_length === undefined) obj.axis_and_length = obj.axis_and_length
    ...
    function arrow_update(obj, vp) { // arrow or vp_arrow (in which case vp is true)
        ...
        if (!components) {
        	if (vp) components = obj.__components = [vp_box({ canvas:obj.canvas, visible: 0 }), 
        	                                         vp_pyramid({ canvas:obj.canvas, visible: 0 })]
        	else components = obj.__components = [box({ canvas:obj.canvas, visible: 0 }), 
                                                  pyramid({ canvas:obj.canvas, visible: 0 })]
    ...
    // point is solely a curve element and is not exported 
    function point(args) {
