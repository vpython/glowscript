; (function () {
        ...
        clone: function(args) {
        	...
        	if (this instanceof curve) {
	        	...
	        	var newargs = {pos:this.__pos, color:this.__color, opacity:this.__opacity, 
	            		...
	            		shininess:this.__shininess, emissive:this.__emissive, texture:this.__texture,
	            		visible:true, pickable:this.__pickable}
    ...
    property.declare( compound.prototype, {
    	...
    	// origin of an extrusion is equivalent to pos, for backward compatibility
    	origin: {
	...
	function radio(args) { // a radio button
		...
		widgetid++
		attrs.id = widgetid.toString()
		$('<span id='+attrs.id+'> '+attrs.text+'</span>').appendTo(attrs.pos)
	...
	function button(args) {
	    ...
	    attrs.jbutton = $('<button/>').html(attrs.text).appendTo(attrs.pos)
	    		.css({"color":rgb_to_css(attrs.textcolor), "font-size":"15px", "background-color":rgb_to_css(attrs.background)})
