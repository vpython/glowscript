; (function () {
	...
	function text(args) {
		if (!(this instanceof text)) return new text(args)
        args = args || {}
        init(this,args)
		...
		if (this.font != 'sans') throw new Error('The font must currently be "sans".')
		if (this.depth !== 0) throw new Error('The depth must currently be 0.')
        drawFont(this) // creates a compound in this.compound
    }
    property.declare( text.prototype, {
    	pos: new attributeVector(null, 0,0,0),
        axis: new attributeVector(null, 1,1,1),
        up: new attributeVector(null, 0,1,0),
        color: new attributeVector(null, 1,1,1),
        text: { value: "", onchanged: function() { this.__change() } },
        align: { value: "left", onchanged: function() { this.__change() } },
        font: { value: "sans", onchanged: function() { this.__change() } },
        height: { value: 1, onchanged: function() { this.__change() } },
        depth: { value: 0, onchanged: function() { this.__change() } },
        opacity: { value: 1, onchanged: function() { this.__change() } },
        visible: { value: false, onchanged: function() { this.__change() } },
        __get_model: function () { return null },
        __change: function () {
        	console.log('text change', this.compound, this.__pos, this.pos.__y)
        	//if (this.compound !== undefined) this.compound.pos = this.__pos
        }
	})
