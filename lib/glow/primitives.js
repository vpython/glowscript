; (function () {
    ...
    */
    ...
    property.declare( Primitive.prototype, {
        ...
        clone: function(args) { // cloning a primitive; cloning a compound is different
			...
			if (this instanceof text) { // the text object is a wrapper around an extrusion, which is a compound
				var oldargs = {canvas:cvs, text:this.__text, __align:this.align,
						...
						__height:this.height, __depth:this.depth, __offset:this.__offset,
						__font:this.font, __billboard: this.billboard, __color:this.color,
						__shininess:this.shininess, __emissive:this.emissive, __opacity:this.opacity,
						...
						__descender:this.descender, __lines:this.lines, visible:true, __pickable:this.__pickable,
						__cloning: true
					}
    ...
    function text(args) { // 3D text object
		...
		if (args.__cloning !== undefined) args.text = print_to_string(args.text)
		var ret = text3D(args) // create a compound object representing the 3D text, as though text.pos is <0,0,0>
		this.__comp = ret[0]
		if (args.__cloning === undefined) args = ret[1]
