; (function () {
    ...
    function compound(objects, parameters) {
        ...
        if (!cloning) { // !cloning means that we're compounding
	        ...
	        if (this.__original_height !== undefined) { // text object
	        	this.__height = this.__original_height
	        	this.__descender = this.__original_descender
	        	this.__original_pseudosize = this.__pseudosize
	        }
	        compound_id++
    ...
    property.declare( compound.prototype, {
    	...
    	height: {
    		...
    		set: function(value) {
        		this.__height = value
    			var k = value/this.__original_height
    			this.size.y = k
        		this.__descender = k*this.__original_descender
    		}
    	},
    	length: {
    		get: function() { return this.__pseudosize.x },
    		set: function(value) {
    			this.size.x = value/this.__original_pseudosize.x
