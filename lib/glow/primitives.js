; (function () {
    ...
    property.declare( Primitive.prototype, {
        ...
        clone: function(args) { // cloning a primitive; cloning a compound is different
        	if (this instanceof text) { // the text object is a wrapper around an extrusion, which is a compound
	        	...
	        	var newargs = {pos:this.__pos, __offset:this.__offset, canvas:this.canvas, __comp:comp,
	            		...
	            		__visible:this.__visible, __pickable:this.__pickable}
        ...
        rotate: function (args) {
	            ...
	            if (obj instanceof compound) obj.__up2 = obj.__up2.rotate({angle:angle, axis:rotaxis})
        },
        ...
        if (!cloning) { // !cloning means that we're compounding
	        ...
	        for (var i = 0; i < objects.length; i++) {
	            ...
	            if (o instanceof triangle || o instanceof quad) {
	            	...
	            	if (o instanceof text) o = o.__comp
	        ...
	        this.__up2 = vec(0,1,0) // up2 will be keep fixed to the compound, to use in world <-> compound transforms
    ...
    property.declare( compound.prototype, {    	
        clone: function(args) { // cloning a compound object
        	var newargs = {pos:this.__pos, color:this.__color, opacity:this.__opacity, 
        			size:this.__size, axis:this.__axis, up:this.__up, __up2:this.__up2,
            		shininess:this.__shininess, emissive:this.__emissive,
            		visible:true, pickable:this.__pickable,
