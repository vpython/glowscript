; (function () {
    ...
    function vertex(args)  {
    	...
    	args = args || {}
    	for (var attr in args) this[attr] = args[attr] // make a copy so that caller doesn't have its args deleted
    ...
    property.declare( compound.prototype, {
    	...
    	billboard: {
    		...
    		set: function(value) {
    			...
    			if (this.canvas.billboards.indexOf(this) == -1) this.canvas.billboards.push(this)
    		}
    	},
    	height: {
