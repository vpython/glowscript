; (function () {
    ...
    function initObject(obj, constructor, args) {
        ...
        if (constructor != points) {
        	if (constructor == arrow) {
                ...
                if (constructor == vp_ring) console.log('4', obj.size)
    ...
    function compound(objects, parameters) {
        ...
        if (!cloning) {
	        ...
	        for (var i = 0; i < objects.length; i++) {
	            var o = objects[i]
	            var ringobj = null
	            if (o instanceof extrusion || o instanceof ring || o instanceof vp_ring) {
    ...
    function curve(args) { // TODO: shrinking a curve's extent doesn't trigger moving the camera inward; dunno why.
        ...
        this['pick'] = null // place holder for reporting which segment of a curve has been picked
    ...
    property.declare( vp_ring.prototype, {
        ...
        thickness: {
        	...
        	set: function(value) {
        		...
        		this.__size.y = this.__size.z = 2*(value + this.radius)
        		this.__change()
        	}
        },
        radius: {
        	...
        	set: function(value) {
        		this.__radius = value
        		this.__size.y = this.__size.z = 2*(value + this.thickness)
        		this.__change()
        	}
        }
    })
